...
class GRIDtoGSSHA(object):
    ...
    netcdf_attributes = {
                        ...
                        'relative_humidity_frac' :
                            #NOTE: CNRFC Usually Specific Humidity
                            #units = "0-1" ;
                            #standard_name = "specific_humidity" ;
                            #long_name = "Specific humidity" ;
                            {
                              ...
                              'hmet_name' : 'RlHm',
                              'conversion_factor' : {
#modified from 1 to .01 for ascii since CNRFC provides Q in wrong unit, so using RH2 instead of Q2, PSFC, T2
                                                        'ascii' : .01,
                                                        'netcdf' : 1,
                                                    },
                            },
                        ...
                        'cloud_cover_pc_4d' :
# Some datasets like from CNRFC can have percent cloud cover as4D, so need a calc_4d_method and dim.  CNRFC files made for FIRO actually fill in all levels other than level 0 (bottom) with a huge number.  So look for the "min", i.e. the non-sorta-infinite value...
                            {
                              'units' : {
                                            'ascii': '%',
                                            'netcdf': '%/10',
